...
namespace ecrs {
	inline namespace relational {
		...
		struct Relation : public RelationBase {
			...
			fp::array<entity_or_term<can_be_term>, N> related;

			constexpr Relation() {}
			constexpr Relation(fp::array<entity_or_term<can_be_term>, N> a): related(a) {}
		...
		struct Relation<std::dynamic_extent, CAN_BE_TERM> : public RelationBase {
			constexpr static bool can_be_term = CAN_BE_TERM;
			fp::dynarray<entity_or_term<can_be_term>> related;

			Relation() {}
			Relation(fp::dynarray<entity_or_term<can_be_term>> a): related(a) {}
